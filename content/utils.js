...
function createOverlay(posx, posy, word)
{
    ...
    <svg class="dictionare_pointer" width="1em" height="1em" viewBox="0 0 16 16" fill="#0000000" xmlns="http://www.w3.org/2000/svg">
...
<div class="dictionare_row">
    ...
    <svg class="dictionare_pointer" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="dictionare_row">
    ...
    <div class="dictionare_right_container">
        <svg class="dictionare_pointer" width="1em" height="1em" viewBox="0 0 16 16" fill="#aaa9ad" xmlns="http://www.w3.org/2000/svg">
